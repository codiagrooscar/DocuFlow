...
-- 9. Configuración de Almacenamiento (Storage)
-- Ejecutar estas líneas para crear el bucket y las políticas
...
-- Permitir a usuarios autenticados actualizar o borrar archivos
CREATE POLICY "Authenticated users can update/delete" ON storage.objects FOR UPDATE USING (
  bucket_id = 'documents' AND auth.role() = 'authenticated'
);
